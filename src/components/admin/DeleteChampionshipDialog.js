...
function DeleteChampionshipDialog({
    open,
    onClose,
    onConfirm,
    championshipName,
    ...
    return (
        <Dialog open={open} onClose={onClose}>
            ...
            <DialogContent>
                ...
                <DialogContentText>
                    <Localized id="admin-delete-championship-confirm" vars={{ champName: championshipName || '' }} />
                </DialogContentText>
            </DialogContent>
...
export default DeleteChampionshipDialog; 